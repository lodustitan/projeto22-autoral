...
export default function Authentication() {
  ...
  function authentication() {
    ...
    if (pageLoginType) {
      axios
        .post(`${import.meta.env.VITE_API_URL}/auth/sign-in`, { account_name: f_login, password: f_pass })
        .then(el => {
      ...
      axios
        .post(`${import.meta.env.VITE_API_URL}/auth/sign-up`, { account_name: f_login, password: f_pass, nickname: f_nickname })
