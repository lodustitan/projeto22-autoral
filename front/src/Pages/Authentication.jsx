...
export default function Authentication() {
  ...
  function authentication() {
    ...
    if (pageLoginType) {
      axios
        .post(`${import.meta.env.VITE_API_URL}/authentication/signin`, { account_name: f_login, password: f_pass })
        .then(el => {
      ...
      axios
        .post(`${import.meta.env.VITE_API_URL}/authentication/signup`, { account_name: f_login, password: f_pass, nickname: f_nickname })
